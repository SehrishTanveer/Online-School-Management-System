...
public class AccountantDelete extends JFrame {
    static AccountantDelete frame;
    ...
    public AccountantDelete() {
        ...
        JLabel lblAdminLoginForm = new JLabel("Delete Accountant");
        ...
        btnDelete.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (sid == null || sid.trim().equals("")) {
                    JOptionPane.showMessageDialog(AccountantDelete.this, "Id can't be blank");
                } else {
                    int id = Integer.parseInt(sid);
                    int i = Accountant.delete(id);
                    if (i > 0) {
                        JOptionPane.showMessageDialog(AccountantDelete.this, "Record deleted successfully!");
                    } else {
                        JOptionPane.showMessageDialog(AccountantDelete.this, "Unable to delete given id!");
                    }
                }
            }
        });
