...
public class TeacherDelete extends JFrame {
    ...
    public TeacherDelete() {
        ...
        JLabel lblAdminLoginForm = new JLabel("Delete Teacher");
        ...
        btnDelete.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (sid == null || sid.trim().equals("")) {
                    JOptionPane.showMessageDialog(TeacherDelete.this, "Id can't be blank");
                } else {
                    int id = Integer.parseInt(sid);
                    int i = Teacher.delete(id);
                    if (i > 0) {
                        JOptionPane.showMessageDialog(TeacherDelete.this, "Record deleted successfully!");
                    } else {
                        JOptionPane.showMessageDialog(TeacherDelete.this, "Unable to delete given id!");
                    }
                }
            }
        });
